...
def two_codon(seed, output_dir, rbs, conf):
    ...
    sim.simulate(time_limit=data["time_limit"], time_step=data["time_step"], output=f"{output_dir}/{description}_{rbs}_{seed}.tsv")


if __name__ == "__main__":
    two_codon(int(sys.argv[1]), sys.argv[2], float(sys.argv[3]), sys.argv[4])
