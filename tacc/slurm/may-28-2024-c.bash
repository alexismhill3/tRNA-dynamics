#!/bin/bash
#SBATCH -J trna-may-28-c            # job name
#SBATCH -o may-28-2024-c.o%j        # output and error file name (%j expands to SLURM jobID)
...
export LAUNCHER_JOB_FILE=/work/07227/hilla3/ls6/tRNA-dynamics/tacc/launcher/may-28-2024-c.txt 
